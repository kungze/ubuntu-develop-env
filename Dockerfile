...
RUN apt-get update \
    && apt install -y iputils-arping iputils-ping iputils-tracepath git vim make iproute2 sudo apt-transport-https ca-certificates curl gnupg-agent software-properties-common wget python3 gcc python3-dev \
